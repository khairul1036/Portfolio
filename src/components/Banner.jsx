    ...
    <section className="max-w-screen-xl mx-auto px-5 py-10 lg:py-20">
      <div className="flex flex-col md:flex-row justify-between items-center md:px-5 lg:px-20">
        ...
        <div className="lg:text-left">
          ...
          <div className="my-8">
            <Link target="_blank" to={'https://drive.google.com/file/d/1FdFONtRt29i4meoPIH_nCNjcJ0bYoiQa/view?usp=sharing'} className="btn border-none bg-gray-200 textColor hover:text-white text-base">
